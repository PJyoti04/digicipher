  ...
  return (
    <button className="relative border-0 cursor-pointer group w-[400px]">
      <div className="relative overflow-hidden bg-red-600 py-4 px-20">
        <span className="absolute top-0 left-0 w-[120%] h-[110%] bg-gray-900 transform -translate-x-[105%] skew-x-[-10deg] transition-transform duration-[.8s] ease-in-out group-hover:translate-x-[-5%] hover:rounded-full"></span>
